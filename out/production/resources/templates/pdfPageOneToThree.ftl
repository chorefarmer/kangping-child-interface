    ...
    <div class="main">
        ...
        <#--<div class="table_wrap_tcf">-->
            <#--<table class="table" width="700" cellspacing="0" cellpadding="0">-->
                ...
                <#--<tr>-->
                    <#--<td>细胞内液(kg)</td>-->
                    <#--<td>${bodyCompositionTest.intracellularFluid}</td>&lt;#&ndash;细胞內液&ndash;&gt;-->
                    <#--<td rowspan="2">${bodyCompositionTest.totalWater}</td>&lt;#&ndash;总体水&ndash;&gt;-->
                    <#--<td rowspan="3"></td>-->
                    <#--<td rowspan="4"></td>-->
                    <#--<td rowspan="5"></td>-->
                <#--</tr>-->
                <#--<tr>-->
                    <#--<td>细胞外液(kg)</td>-->
                    <#--<td>${bodyCompositionTest.extracellularFluid}</td>&lt;#&ndash;细胞外液&ndash;&gt;-->
                    <#--&lt;#&ndash;<td></td>&ndash;&gt;-->
                    <#--&lt;#&ndash;<td></td>&ndash;&gt;-->
                    <#--&lt;#&ndash;<td></td>&ndash;&gt;-->
                    <#--&lt;#&ndash;<td></td>&ndash;&gt;-->
                ...
                <#--<tr>-->
                    <#--<td>蛋白质(kg)</td>-->
                    <#--<td>${bodyCompositionTest.protein}</td>&lt;#&ndash;蛋白质&ndash;&gt;-->
                    <#--<td colspan="2">${bodyCompositionTest.muscle}</td>&lt;#&ndash;肌肉量&ndash;&gt;-->
                <#--</tr>-->
                <#--<tr>-->
                    <#--<td>无机盐(kg)</td>-->
                    <#--<td>${bodyCompositionTest.sclerotin}</td>&lt;#&ndash;无机盐&ndash;&gt;-->
                    <#--<td colspan="3">${bodyCompositionTest.fatfreeBodyWeight}</td>&lt;#&ndash;瘦体重&ndash;&gt;-->
                    <#--&lt;#&ndash;<td></td>&ndash;&gt;-->
                    <#--&lt;#&ndash;<td></td>&ndash;&gt;-->
                    <#--&lt;#&ndash;<td></td>&ndash;&gt;-->
                <#--</tr>-->
                <#--<tr>-->
                    <#--<td>脂肪(kg)</td>-->
                    <#--<td>${bodyCompositionTest.fat}</td>&lt;#&ndash;脂肪&ndash;&gt;-->
                    <#--<td colspan="4">${bodyCompositionTest.weight}</td>&lt;#&ndash;体重&ndash;&gt;-->
                    <#--&lt;#&ndash;<td></td>&ndash;&gt;-->
                    <#--&lt;#&ndash;<td></td>&ndash;&gt;-->
                    <#--&lt;#&ndash;<td></td>&ndash;&gt;-->
                <#--</tr>-->
        ...
        <div class="table_wrap_sport">
            <table class="table" width="700" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td>注意事项</td>
                    <td>每天看电视、玩平板电脑的累计时间不超过2小时</td>
                </tr>
                <tr>
                    <td>高强度运动</td>
                    <td>适量做较高强度的运动和户外活动，包括有氧运动（骑小自行车、快跑等）</td>
                </tr><tr>
                    <td>肌肉强化</td>
                    <td>伸展运动、肌肉强化运动（攀架、健身球等）、团体活动（跳舞、小型球类游戏等）</td>
                </tr>
